...
class PLUGIN_ALOHAWriter(aloha_writers.ALOHAWriterForCPP):
...
class PLUGIN_UFOModelConverter(export_cpp.UFOModelConverterCPP):
    ...
    def write_process_h_file(self, writer):
        ...
        replace_dict = super(PLUGIN_UFOModelConverter, self).write_process_h_file(self, None)
...
class PLUGIN_OneProcessExporter(export_cpp.OneProcessExporterCPP):
    ...
    def __init__(self, *args, **opts):
        ...
        super(PLUGIN_OneProcessExporter, self).__init__(*args, **opts)
        self.process_class = "CPPProcess"

    def generate_process_files(self):
        
        super(PLUGIN_OneProcessExporter, self).generate_process_files()
    ...
    # parse: gpu/process_function_definitions.inc
    # ===========================================================================
...
{""")
    ...
    def write_process_h_file(self, writer):
        ...
        # move function definitions to header file from gpu/process_function_definitions.inc
        ...
        # Extract class definitions from gpu/process_class.inc
